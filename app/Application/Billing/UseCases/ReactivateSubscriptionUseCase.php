...
final class ReactivateSubscriptionUseCase
{
    ...
    public function execute(ReactivateSubscriptionInput $input): SubscriptionOutput
    {
        ...
        if ($subscription->externalSubscriptionId !== null) {
            $this->paymentGateway->reactivateSubscription($subscription->externalSubscriptionId);
        }
