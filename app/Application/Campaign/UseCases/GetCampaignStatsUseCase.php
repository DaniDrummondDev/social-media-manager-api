...
final class GetCampaignStatsUseCase
{
    ...
    public function execute(string $organizationId, string $campaignId): CampaignStatsOutput
    {
        ...
        return CampaignStatsOutput::fromCounts($counts);
    }
}
