...
final class CompleteContractUseCase
{
    public function __construct(
        private readonly ClientContractRepositoryInterface $contractRepository,
    ) {}

    public function execute(string $contractId, string $organizationId, string $userId): ContractOutput
    {
        ...
        $contract = $contract->complete($userId);
