...
final class StubMetaAdPlatform implements AdPlatformInterface
{
    ...
    {
        return [
            'auth_url' => "https://www.facebook.com/v19.0/dialog/oauth?client_id=stub&redirect_uri={$redirectUri}&state={$state}&scope=ads_management",
            'state' => $state,
        ];
    }
    ...
    {
        return [
            'access_token' => 'meta_stub_at_'.bin2hex(random_bytes(16)),
            'refresh_token' => null,
            'expires_at' => (new DateTimeImmutable('+60 days'))->format('c'),
            'account_id' => 'act_'.str_pad((string) random_int(100000000, 999999999), 9, '0'),
            'account_name' => 'Stub Meta Ads Account',
    ...
    public function createCampaign(
        ...
        return [
            'campaign_id' => 'meta_camp_'.bin2hex(random_bytes(8)),
        ];
    }
    ...
    public function createAdSet(
        ...
        return [
            'adset_id' => 'meta_adset_'.bin2hex(random_bytes(8)),
        ];
    }
    ...
    public function createAd(
        ...
        return [
            'ad_id' => 'meta_ad_'.bin2hex(random_bytes(8)),
        ];
    }
    ...
    {
        return [
            ['id' => '6003139266461', 'name' => 'Technology', 'audience_size' => 500000000],
            ['id' => '6003397425735', 'name' => 'Digital marketing', 'audience_size' => 200000000],
            ['id' => '6003020834693', 'name' => 'Entrepreneurship', 'audience_size' => 150000000],
        ];
    }
